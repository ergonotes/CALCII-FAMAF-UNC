...
Dada una sucesión de números reales $(a*n)*{n=1}^\infty$, una **subsucesión** es una nueva sucesión $(a*{n_k})*{k=1}^\infty$ que se obtiene seleccionando ciertos términos de la sucesión original, manteniendo estrictamente el orden en el que aparecían.
...
Si $\lim*{n \to \infty} a_n = L$, entonces para cualquier subsucesión $(a*{n*k})$, se cumple que:
$$\lim*{k \to \infty} a_{n_k} = L$$

- - -

**En otras palabras.** Sea $(a*n)$ una sucesión de números reales. Si la sucesión $(a_n)$ converge a un límite $L$, entonces toda subsucesión $(a*{n_k})$ extraída de ella también es convergente y su límite es exactamente el mismo $L$.
